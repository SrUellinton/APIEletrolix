...
if (isset($_POST['btn-entrar'])) :
    ...
    $dados_status = mysqli_fetch_array($result_status);
      ...
      Verifique os campos de email e senha, e preencha-os, é possivel que estejam vazios!
            ...
            $sql = "SELECT id, email,status FROM users WHERE email = '$login'";
        ...
        Usuário $login, não possui cadastro em nosso sistema!
    </div>";
...
<body class=" " style="background-color: #FFF !important;">
    ...
    <!-- loader END -->
    <div class="wrapper">
        <section class="iq-auth-page" style="background-color: #f1edec;">
            <div class="row d-flex align-items-center justify-content-center vh-100 w-100">
                <div class="col-md-4 col-xl-4">
                    <div class="card " style="background-color: #f1edec; box-shadow: none; border:none;">
                        <div class="card-body ">
                            <h3 class="text-center"><img src="assets/images/logo_completo_valan_vertical.png" height="200" alt=""></h3>
                            <h3 class="text-center">Insirá suas credenciais</h3>
                            <form action="" method="post" autocomplete="off">
                                <div class="form-floating mb-3 mt-4">
                                    <input type="email" name="email"  class="form-control form-control-lg rounded-pill" id="floatingInput">
                                    <label for="floatingInput">Email</label>
                                </div>
                                <div class="form-floating">
                                    <input type="password" name="senha" class="form-control form-control-lg rounded-pill" id="floatingPassword">
                                    <label for="floatingPassword">Senha</label>
                                </div>

                                <div class="text-center pb-3">
                                    <button type="submit" name="btn-entrar" class="btn btn-primary btn-lg rounded-pill mt-5" style="background-color: #282737; border: 1px solid #282737;">Acessar o app</button>
                                </div>
                            </form>
                            <p class="text-center mt-5">Não possui sua conta Valan?<a href="cadastre_se.php" class=" ms-2"> Cadastre-se.</a></p>
                        </div>
                    </div>
                </div>
            </div>
