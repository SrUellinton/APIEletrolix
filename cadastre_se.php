            ...
            <div class="row d-flex align-items-center justify-content-center vh-100 w-100">
                <div class="col-md-4 col-xl-4">
                    <div class="card " style="background-color: #f1edec; box-shadow: none; border:none;">
                        <div class="card-body ">
                            <h3 class="text-center mb-3"><img src="assets/images/logo_completo_valan_vertical.png" height="200" alt=""></h3>
                            <h3 class="text-center"></h3>
                            <h3 class="text-center">Acesse nosso cadastro de pré-venda: cadatro.valan.com.br/prevenda</h3>
                            
                            <p class="text-center mt-5"><a href="index.php" class="btn btn-primary btn-lg rounded-pill mt-5"> Voltar ao login</a></p>
                        </div>
                    </div>
                </div>
            </div>
