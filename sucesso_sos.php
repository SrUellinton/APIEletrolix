    ...
    <div class="row d-flex align-items-center justify-content-center text-center mt-5">
        <div class="col-md-8 d-flex align-items-center justify-content-center text-center">
            <div class="card" style="background-color:#f1f4f8; width: 420px;">
                ...
                <div class="body">
                    <h5 class="mt-2">Recebemos seu acionamento</h5>
                    <form action="painel.php" method="post">
                        <div class="row d-flex align-items-center justify-content-center text-center">
                        <h5 class="mt-2">Pedimos que permaneça em um lugar seguro para sua segurança, nossa equipe está acionando as altoridades,
                            pegamos sua localização e os dados do acionamento, dentro de alguma minutos entraremos em contato.</h5>
                            <h4><button type="submit" class="btn btn-primary btn-lg rounded-pill mt-5 mb-5" style="background-color: #8A1213; border: 1px solid #8A1213;">voltar ao painel</button></h4>
                        </div>
                    </form>
                </div>
            </div>
